...
RCT_EXTERN_METHOD(signPSS64:(NSString *)message algorithmOID:(NSString *)algorithmOID withKey:(NSString *)withKey resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject)
